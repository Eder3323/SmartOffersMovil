...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_offers and try to insert new data
        config.model.insert_offers(
            form['name'],form['description'],form['creator'],form['product_name'],form['price'],form['discount_value'],form['new_price'],form['created'],
        )
