...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_companies and try to insert new data
        config.model.insert_companies(
            form['name'],form['description'],form['owner'],form['type'],form['address'],form['created'],
        )
