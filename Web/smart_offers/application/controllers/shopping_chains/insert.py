...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_shopping_chains and try to insert new data
        config.model.insert_shopping_chains(
            form['client'],form['offer'],form['status'],form['creator'],form['limited_time'],form['created'],
        )
